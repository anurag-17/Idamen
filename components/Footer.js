...
import logofooter from '../components/image/footer-logo.svg'
...
<div className="flex foot-wrapper max-w-7xl mx-auto justify-center items-center lg:justify-between py-10">
    ...
    <div className="mr-12 hidden lg:block text-black">
      <span className='text-2xl	font-semibold text-black'>Subscribe to our NewsLetter! </span>
      <p className='text-black	 mt-3'> We send the newsletter once a week every friday </p>
    </div>
...
">
   ...
   <div className="form-group mr-2">
    ...
    <button type="submit" className="
     font-bold font-Quicksand items-center hovs inline-block px-14 bg-black-500	text-white text-sm leading-tight rounded-full	shadow-md
 ...
 <Image className="" src={logofooter.src} alt="" width={200} height={59}/>

        </h6>
        <p class="">
        Idamen Systems’s solutions are fit for a variey of use cases and cuts across all sectors, providing private and public cloud services, as well as managed hosting to ensure reliability and performance.  </p>
      </div>
      <div className="lg:w-3/12 md:w-4/12 sm:w-12/12 lg:pl-20 max-[600px]:mb-3">
        ...
        <li className="sm:mt-4 sm:mb-1 lg:mb-4">
          <a href="#!" className="text-gray-600">Claim</a>
        </li>
        <li  className="sm:mb-1 lg:mb-4">
...
<rect width="21" height="21" fill="white"/>
        ...
        <a href='tel;+1 (864) 774-9810'>+1 (864) 774-9810</a>  
        </p>
         </div>
