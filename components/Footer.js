...
const Footer = () => {
  ...
  return (
    <div>
     {serviceoffering?( <footer className="text-center lg:text-left bg-stons-900 text-zinc-400	">
      ...
      ease-in-out"
        ...
        <div className="max-w-7xl  mx-auto foot-wrapper">
          ...
          "
                ...
                <p class="">
                  Idamen Systems’s solutions are fit for a variey of use cases
                  and cuts across all sectors, providing private and public
                  cloud services, as well as managed hosting to ensure
              ...
              <div className="lg:w-3/12 md:w-4/12 sm:w-12/12 max-[600px]:mb-3">
                ...
                <p className="flex items-center justify-center md:justify-start mb-4 footer-para-linkss">
                  ...
                  <a href={`${serviceoffering[1]["attributes"].description}`}>
                    {serviceoffering[1]["attributes"].description}
                  </a>
                </p>
              </div>
              <div className="lg:w-2/12 md:w-4/12 sm:w-12/12 socials lg:pl-10 max-[600px]:mb-3">
                ...
                <div className="social-icons-centers flex justify-left">
                  <a href= {serviceoffering[2]["attributes"].description} className="mr-2  sm:float-right  text-gray-600">
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fab"
