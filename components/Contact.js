...
<h3 className="text-xls font-extrabold font-Quicksand mb-2 mt-4">Contact Us</h3>
<p className="text-base text-gray-400 font-regular font-Quicksand">We also aim to provide an engaging experience for our customers, by<br/> providing a comprehensive suite of cloud-native solutions, </p>

</div>


<div className="cnt max-w-7xl m-auto cn-fo mt-9 mb-20 mx-auto">
  <div className="md:block lg:flex items-center w-100 ">
    ...
    <div className="mb-12 grow-0 shrink-0 basis-auto border-b-1 w-full">
             ...
             <svg className='w-8 text-black' width="50" height="50" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.74598 14.5501L11.8115 21.3036C12.1963 21.8165 12.8094 22.1484 13.5 22.1484C14.1906 22.1484 14.8037 21.8165 15.1885 21.3036L20.254 14.5501C21.3112 13.1407 21.9375 11.3896 21.9375 9.49219C21.9375 4.83232 18.1599 1.05469 13.5 1.05469C8.84007 1.05469 5.06249 4.83232 5.06249 9.49219C5.06249 11.3896 5.68887 13.1407 6.74598 14.5501Z" stroke="black" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15.6094 9.49219C15.6094 10.6571 14.665 11.6016 13.5 11.6016C12.335 11.6016 11.3906 10.6571 11.3906 9.49219C11.3906 8.32723 12.335 7.38281 13.5 7.38281C14.665 7.38281 15.6094 8.32723 15.6094 9.49219Z" stroke="black" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.28125 25.9453H17.7187" stroke="black" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                ...
                <div className="grow ml-6">
                  <p className="font-semibold mb-3 text-xl text-black-500">Address</p>
                  <p className="text-black-500">9450 SW Gemini Dr PMB 45476 Beaverton,<br/> Oregon 97008-7105</p>
                </div>
              </div>
            </div>
...
<rect width="26" height="26" fill="white"/>
                ...
                <div className="grow ml-6">
                  <p className="font-semibold mb-3 text-xl text-black-500">Phone</p>
                  <p className="text-black-500"> <a href='tel:+1 (864) 774-9810'> +1 (864) 774-9810</a> </p>
                </div>
              </div>
            </div>
...
<path d="M24.627 4.00781H2.37305C1.06191 4.00781 0 5.07632 0 6.38086V20.6191C0 21.9314 1.06972 22.9922 2.37305 22.9922H24.627C25.9271 22.9922 27 21.9359 27 20.6191V6.38086C27 5.07864 25.9423 4.00781 24.627 4.00781ZM24.2946 5.58984C23.8098 6.0721 15.4661 14.3719 15.178 14.6584C14.7298 15.1067 14.1339 15.3535 13.5 15.3535C12.8661 15.3535 12.2702 15.1066 11.8205 14.6569C11.6268 14.4642 3.37516 6.25609 2.70538 5.58984H24.2946ZM1.58203 20.2971V6.70386L8.41841 13.5042L1.58203 20.2971ZM2.70638 21.4102L9.54007 14.6199L10.7033 15.7771C11.4504 16.5241 12.4436 16.9355 13.5 16.9355C14.5564 16.9355 15.5496 16.5241 16.2952 15.7785L17.4599 14.6199L24.2936 21.4102H2.70638ZM25.418 20.2971L18.5816 13.5042L25.418 6.70386V20.2971Z" fill="black"/>
                ...
                <div className="grow ml-6">
                  <p className="font-semibold mb-3 text-xl text-black-500">Email</p>
                  <p className="text-black-500"><a href="mailto:info@idamen.com">info@idamen.com</a></p>  
                </div>
              </div>
            </div>
  ...
  <form>
    ...
    transition
    ease-in-out
        focus:outline-none" id="exampleInput8"
        placeholder="Email"/>
    </div>
    <div className="form-group mb-5">
      <textarea
    ...
    <button type="submit" className="
      w-full px-5 py-4 text-sm text-bold hovs uppercase text-white font-extrabold bg-black-500 border border-solid border-gray-300 rounded-full transition ease-in-out">Submit</button>
  </form>
</div>
